...
function StartState:update(dt)
    ...
    if love.keyboard.wasPressed('up') then
        highlighted = highlighted == 1 and 3 or highlighted == 2 and 1 or 2
        gSounds['paddle-hit']:play()
    end
    if love.keyboard.wasPressed('down') then
        highlighted = highlighted == 1 and 2 or highlighted == 2 and 3 or 1
        gSounds['paddle-hit']:play()
    end
...
function StartState:render()
    ...
    -- if we're highlighting 2, render that option blue
