...
function GenerateQuadsPowerups(atlas)
    ...
    -- add 7th and 10th powerup
    quads[4] = love.graphics.newQuad(16 * 6, y, 16, 16, atlas:getDimensions())
    quads[5] = love.graphics.newQuad(16 * 9, y, 16, 16, atlas:getDimensions())
